...
macOSAlternative:
  ...
  breaksDownWhen:
    ...
    has RAW and PSD files mixed in with the HEICs, the Quick Action offers three
    formats and four named size presets, and gives you no per-file result.
related:
  - heic-to-png
  - jpg-to-webp
  - raw-to-jpg
...
That codec is considerably better at its job than JPEG's, which dates to 1992,
and it is the whole reason Apple switched.
...
WebP, PSD, TIFF, GIF, and HEIC itself, which can carry alpha. It is the
